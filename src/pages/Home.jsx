...
const Home = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4">
      {videos.map((video) => (
        <div key={video._id} className="rounded-lg shadow-md overflow-hidden bg-slate-900  sm:h-96">
          <div className="relative">
            <video width="100%" height="auto" controls muted className="block w-full">
          ...
          <div className="p-4">
            <h3 className="text-lg font-semibold text-gray-50 line-clamp-2">{video.videoTitle}</h3>
