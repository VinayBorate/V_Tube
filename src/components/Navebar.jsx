...
const Navebar = (props) => {
  ...
  return (
    ...
    {/*------------------------------- Logo ----------------------------------------------------*/}
      ...
      {/* ------------------------------------Search bar -------------------------------------------*/}
<form className="px-5 max-w-xl mx-auto mt-1 sm:flex">
      {/* Conditionally render the search input (renderof search bar depends on path) */}
        ...
        <>
          ...
          <div className="relative sm:w-96">
            ...
            <input
              type="search"
              id="default-search"
              className="sm:w-full block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search"
              required
            />
            <button
